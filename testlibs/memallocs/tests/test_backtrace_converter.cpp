...
void test_backtrace_converter::testCreateBacktrace()
{
    ...
    MemoryAllocBacktraceGenerator::BacktraceRaw backtrace =
        TestBacktraceGenerator::createBacktrace(testTace, ignoreOffset);
...
{
    MemoryAllocTracker::MemsAllocated alloc;
    ...
    BacktraceConverter::AllocMemTraces converted = BacktraceConverter::backtracesRawToVoidLists(alloc);
